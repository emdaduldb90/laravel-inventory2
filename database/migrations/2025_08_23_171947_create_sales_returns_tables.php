...
return new class extends Migration {
    public function up(): void {
        ...
        Schema::create('sales_return_items', function (Blueprint $t) {
            ...
            $t->decimal('unit_price', 18, 4)->default(0);  // customer price (for credit)
            $t->decimal('unit_cost', 18, 4)->nullable();   // valuation cost; null => use current avg_cost
